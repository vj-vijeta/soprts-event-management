                                ...
                                .then(ucode => {
                                    if (ucode) {
                                        ...
                                        newUcode = new db.Ucode({
                                            initial_id: 1000,
                                            next_id: 1001,
                                            EventNames: ["Run bird","cm trophy","pm trophy","league of runners","runforgracr","selection trials","firsts","tornamentalls","Inauguralfest","sportsFest","athelaticsair","sportsFest2","annualSportday"]
                                        })
                                        newUcode.save()
                                        const newUser = new db.User({
                                            UniqueId: 1000,
